...
const useCases = [
  ...
  },
  {
    ...
    description: 'Toplu işletme verilerini ister Veriburada CRM ile isterseniz kendi CRM sisteminize aktarın. Müşteri yönetimi, segmentasyon ve otomatik pazarlama için hazır veri tabanı oluşturun.',
    icon: (
      <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
